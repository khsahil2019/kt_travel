...
class _DestinationWeddingState extends State<DestinationWedding> {
                ...
                Container(
                  child: Column(
                    children: [
                      ...
                      DestinationWedding(width, "desti1.jpg"),
                      DestinationWedding(width, "desti2.jpeg"),
                      DestinationWedding(width, "desti3.jpeg"),
                      DestinationWedding(width, "desti4.jpeg"),
                      DestinationWedding(width, "desti1.jpg"),
                      DestinationWedding(width, "desti2.jpeg"),
                      DestinationWedding(width, "desti3.jpeg"),
                      DestinationWedding(width, "desti4.jpeg"),
  ...
  Widget DestinationWedding(double width, String img) {
    return Padding(
